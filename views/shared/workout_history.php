<?php
// Expects: $role ('member'|'trainer'), $data from WorkoutController->handleWorkoutTracking()
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Workout History - FitNexus</title>
...
<body>
    <?php if ($role === 'trainer') { include __DIR__ . '/../utilities/alert.php'; } ?>
