...
$sort_by = $_GET['sort_by'] ?? 'trainer_id';
...
<body>
    ...
    <div class="main-content">
        <div class="content-wrapper">
            <div class="dashboard-header">
                ...
                <p>Manage trainer profiles, specialties, and assignments.</p>
            </div>
                ...
                <div class="filters-section" style="display: flex; flex-direction: column; gap: 10px; align-items: flex-start;">
                    <div class="filters-row" style="display: flex; gap: 15px; align-items: center; flex-wrap: wrap;">
                        <select id="filter_specialty" onchange="applyFilters()" style="padding: 8px 12px; border: 2px solid #e9ecef; border-radius: 6px; font-size: 14px; background: #fff; min-width: 140px;">
                            ...
                            <option value="Personal Training" <?php echo ($filter_specialty === 'Personal Training') ? 'selected' : ''; ?>>Personal Training</option>
                        </select>
                        ...
                        <select id="sort_by" onchange="applyFilters()" style="padding: 8px 12px; border: 2px solid #e9ecef; border-radius: 6px; font-size: 14px; background: #fff; min-width: 140px;">
                            <option value="" disabled <?php echo (empty($sort_by) || $sort_by === 'trainer_id') ? '' : 'selected'; ?>>Sort by</option>
                ...
                <table class="users-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($trainer['email'] ?? 'N/A'); ?></td>
                            <td><?php echo htmlspecialchars($trainer['phone'] ?? 'N/A'); ?></td>
                            <td>
                                <div class="action-buttons">
                                    <button class="action-btn btn-edit" onclick="openEditTrainerModal(<?php echo $trainer['trainer_id']; ?>, '<?php echo htmlspecialchars($trainer['full_name']); ?>', '<?php echo htmlspecialchars($trainer['email'] ?? ''); ?>', '<?php echo htmlspecialchars($trainer['phone'] ?? ''); ?>', '<?php echo htmlspecialchars($trainer['specialty'] ?? ''); ?>')" title="Edit Trainer">
    ...
    <script>
        ...
        function openEditTrainerModal(trainerId, fullName, email, phone, specialty) {
        ...
        function openDeleteTrainerModal(trainerId, fullName) {
            document.getElementById('delete_trainer_id').value = trainerId;
            document.getElementById('delete_trainer_name').textContent = fullName;
